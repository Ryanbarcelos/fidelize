...
interface FidelityCardItemProps {
  card: {
    id: string;
    balance: number;
    logo?: string;
...
export const FidelityCardItem = ({ card }: FidelityCardItemProps) => {
  ...
  return (
    <div
      onClick={() => navigate(`/fidelity-card/${card.id}`)}
